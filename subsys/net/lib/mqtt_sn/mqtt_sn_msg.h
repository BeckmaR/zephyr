...
{
	return net_buf_simple_add_u8(&msg->buf, val);
}

static inline void mqtt_sn_msg_add_be16(struct mqtt_sn_msg *msg, uint16_t val)
{
	return net_buf_simple_add_be16(&msg->buf, val);
}
...
{
	return net_buf_simple_add_mem(&msg->buf, mem->data, mem->size);
}

static inline void *mqtt_sn_msg_add(struct mqtt_sn_msg *msg, size_t sz)
{
	return net_buf_simple_add(&msg->buf, sz);
}

static inline uint8_t mqtt_sn_msg_remove_u8(struct mqtt_sn_msg *msg)
{
	return net_buf_simple_remove_u8(&msg->buf);
}

static inline uint16_t mqtt_sn_msg_remove_be16(struct mqtt_sn_msg *msg)
{
	return net_buf_simple_remove_be16(&msg->buf);
}

static inline uint8_t mqtt_sn_msg_pull_u8(struct mqtt_sn_msg *msg)
{
	return net_buf_simple_pull_u8(&msg->buf);
}

static inline uint16_t mqtt_sn_msg_pull_be16(struct mqtt_sn_msg *msg)
{
	return net_buf_simple_pull_be16(&msg->buf);
}

static inline uint16_t mqtt_sn_msg_pull_le16(struct mqtt_sn_msg *msg)
{
	return net_buf_simple_pull_le16(&msg->buf);
}
...
struct mqtt_sn_msg *mqtt_sn_encode_msg(struct mqtt_sn_param *params);
